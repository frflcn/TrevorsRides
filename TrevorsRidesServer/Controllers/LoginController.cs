        ...
        public async void DriverOnGet()
        {
            ...
            using (RidesModel context = new RidesModel())
            {
                ...
                try
                {
                    if (userId != null)
                    {
                        account = context.DriverAccounts.ToList().Single(e => e.Id == userId);
                    }
                    else
                    {
                        account = context.DriverAccounts.ToList().Single(e => e.Email == email);
                    }
                ...
                context.DriverAccounts.Update(account);
                context.SaveChanges();
                return;
            }
        }
